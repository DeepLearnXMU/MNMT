...
def train_mm_opts(parser):
    ...
    parser.add_argument('-path_to_train_img_feats', default=None, #required=True,
                        help="""Path to hdf5 file containing training image features""")
    parser.add_argument('-path_to_valid_img_feats', default=None, #required=True,
...
def translate_mm_opts(parser):
    parser.add_argument('-path_to_test_img_feats',default=None, #required=True,
